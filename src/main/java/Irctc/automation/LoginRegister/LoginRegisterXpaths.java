...
public class LoginRegisterXpaths {
    ...
    public String loginButtonXpathTwo = "//button[text()='LOGIN']";//For smaller resolution screens
    ...
    public String errorMessageCssSelector = "div[class='loginError']";
    public String registerButton = "//label[text()='REGISTER']";
}
